...
<div id="wrapper">
      ...
      <div class="login-form white-box">
          <h1 class="login-heading-text color-gray">Time Log</h1>
          <div class="login-form-padding">
              <form method="POST" action="/" class="floating-labels">
                  <div class="form-group">
                      <input id="username" class="form-control" name="username" required="" type="text">
                      <span class="highlight"></span>
                      <span class="bar"></span>
                      <label for="username" class="color-gray">Employee ID</label>
                  ...
                  <button type="submit" class="btn btn-info waves-effect waves-light">Log</button>
